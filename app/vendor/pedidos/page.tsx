                    ...
                    >
                      ...
                      <div className="space-y-1.5 pb-3 border-b border-gray-100">
                        ...
                        <div className="flex flex-wrap gap-1">
                          ...
                          <span className="rounded-full px-2 py-0.5 text-[9px] font-bold uppercase tracking-wider bg-[#d97757]/10 text-[#d97757]">
                        ...
                        <div className="space-y-2 max-h-48 overflow-y-auto">
                          {order.items.map((item, idx) => (
                            <div key={idx} className="text-[12px] text-[#1C2526]">
                              ...
                              {item.notes && (
                                <div className="text-[10px] italic text-[#d97757] pl-3">
                                  Nota: {item.notes}
                                </div>
                              )}
                            </div>
