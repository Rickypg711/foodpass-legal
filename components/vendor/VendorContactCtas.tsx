  ...
  return (
    <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
      <Link
        ...
        className="inline-flex min-h-11 w-full items-center justify-center rounded-full bg-[#F28C38] px-6 py-3.5 text-center text-sm font-semibold text-white shadow-md shadow-[#F28C38]/20 transition-colors hover:bg-[#c46644] sm:w-auto"
      >
