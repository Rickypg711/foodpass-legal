        ...
        <div className="text-center">
          ...
          <div className="mt-6 flex flex-col gap-3">
            ...
            <button
              ...
              disabled={stage === "signing"}
              className="flex w-full items-center justify-center gap-3 rounded-xl bg-[#1877F2] px-6 py-3.5 text-sm font-semibold text-white shadow-sm transition-all hover:bg-[#166fe5] disabled:cursor-not-allowed disabled:opacity-60"
            >
