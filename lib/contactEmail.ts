...
/** Comeleal WhatsApp Business (link base, MX +52). JAMÁS wa.me: rompe los emojis. */
export const PUBLIC_WHATSAPP_WA_ME =
  "https://api.whatsapp.com/send/?phone=526146017597&type=phone_number&app_absent=0";

/** Ayuda del panel del vendor — abre WhatsApp con contexto ("te contesta una persona"). */
export const PUBLIC_WHATSAPP_WA_ME_VENDOR_HELP =
  "https://api.whatsapp.com/send/?phone=526146017597&type=phone_number&app_absent=0&text=" +
  encodeURIComponent("Hola, necesito ayuda con mi panel de Comeleal 🙏");

/** Pre-filled message for vendor activation intent. */
export const PUBLIC_WHATSAPP_WA_ME_ACTIVATE =
  "https://api.whatsapp.com/send/?phone=526146017597&type=phone_number&app_absent=0&text=Hola%2C%20quiero%20activar%20mi%20negocio%20en%20Comeleal.%0A%0ANombre%20del%20negocio%3A%0ACiudad%3A%0ATipo%20de%20negocio%3A%0A%0A%C2%BFMe%20pueden%20ayudar%20a%20configurar%20mi%20men%C3%BA%2C%20horario%20y%20recompensa%3F";
